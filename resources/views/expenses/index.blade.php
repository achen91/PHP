...
<!-- BEGIN PAGE HEADING -->
    <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
        ...
        <h1 class="page-title no-line-height">费用
        @permission(['manage-gymie','manage-expenses','add-expense'])
        <a href="{{ action('ExpensesController@create') }}" class="page-head-btn btn-sm btn-primary active" role="button">新增</a>
        <small>gym费用的详细信息</small></h1>
        @permission(['manage-gymie','pagehead-stats'])
        <h1 class="font-size-30 text-right color-blue-grey-600 animated fadeInDown total-count pull-right"><span  data-toggle="counter" data-start="0" data-from="0" data-to="{{ $count }}" data-speed="600" data-refresh-interval="10"></span> <small class="color-blue-grey-600 display-block margin-top-5 font-size-14">费用记录总数</small></h1>
        @endpermission
        @endpermission
    </div><!-- / PageHead -->
        ...
        <div class="panel no-border ">
          <div class="panel-title bg-blue-grey-50">
                ...
                <div class="row"> 
                        <div class="col-sm-12 no-padding">
                            {!! Form::Open(['method' => 'GET']) !!}
                                ...
                                {!! Form::label('expense-daterangepicker','日期范围') !!}
                                ...
                                <div class="col-sm-2">                                        
                                    ...
                                    <select id="category_id" name="category_id" class="form-control selectpicker show-tick show-menu-arrow">
                                      <option value="0" <?php echo $client_catid == 0 ? 'selected="selected" ' : '' ?>>全部</option>
                                ...
                                <div class="col-sm-2">                                        
                                    ...
                                    {!! Form::select('sort_field',array('created_at' => '日期','name' => '名称','amount' => '总价','due_date' => '截止日期','category_name' => '种类名称'),old('sort_field'),['class' => 'form-control selectpicker show-tick show-menu-arrow', 'id' => 'sort_field']) !!}
                                </div>
            ...
            <table id="expenses" class="table table-bordered table-striped">             
              <thead>
                <tr>
                  ...
                  <th class="text-center">费用种类</th>
                  <th class="text-center">合计</th>                  
                  <th class="text-center">重复</th>
            ...
            <tr>
              ...
              <td class="text-center"><i class="fa fa-rmb"></i> {{ $expense->amount }}</td>              
              ...
              <div class="row">
                <div class="col-xs-6">
                  <div class="gymie_paging_info">
                    当前页: {{ $expenses->currentPage() }} / {{ $expenses->lastPage() }}
                  </div>
                </div>
