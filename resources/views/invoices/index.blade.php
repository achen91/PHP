...
<div class="rightside bg-grey-100">
  <!-- BEGIN PAGE HEADING -->
    <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
        ...
        <h1 class="page-title no-line-height">单据
        <small>gym单据的详细信息</small></h1>
        @permission(['manage-gymie','pagehead-stats'])
        <h1 class="font-size-30 text-right color-blue-grey-600 animated fadeInDown total-count pull-right"><span  data-toggle="counter" data-start="0" data-from="0" data-to="{{ $count }}" data-speed="600" data-refresh-interval="10"></span> <small class="color-blue-grey-600 display-block margin-top-5 font-size-14">发票总数</small></h1>
        @endpermission
    </div><!-- / PageHead -->
        ...
        <div class="panel no-border ">
          <div class="panel-title bg-blue-grey-50">
                        ...
                        <div class="row"> 
                                <div class="col-sm-12 no-padding">
                                    {!! Form::Open(['method' => 'GET']) !!}
                                        ...
                                        {!! Form::label('invoice-daterangepicker','日期范围') !!}
                                        ...
                                        <div class="col-sm-2">                                        
                                            ...
                                            {!! Form::select('sort_field',array('created_at' => '日期','invoice_number' => '单据号','member_name' => '成员名称','total' => '总价格','pending_amount' => '冻结金额'),old('sort_field'),['class' => 'form-control selectpicker show-tick show-menu-arrow', 'id' => 'sort_field']) !!}
                                        </div>
            ...
            <div class="panel-body bg-white">
              @if($invoices->count() == 0)
              <h4 class="text-center">对不起! 没有记录</h4>
              @else
              ...
              <div class="row">
                <div class="col-xs-6">
                  <div class="gymie_paging_info">
                    当前页: {{ $invoices->currentPage() }} / {{ $invoices->lastPage() }}
                  </div>
                </div>
