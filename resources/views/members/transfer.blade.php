...
<div class="panel no-border">
<div class="panel-title">
<div class="panel-head font-size-20">输入签署细节</div>
</div>

                <div class="panel-body">
                            <div class="row">
                    <div class="col-sm-5">
                        {!! Form::label('plan_0','套餐') !!}
                    </div>

                    <div class="col-sm-3">
                        {!! Form::label('start_date_0','开始日期') !!}
                    </div>

                    <div class="col-sm-3">
                        {!! Form::label('end_date_0','截止日期') !!}
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-2 pull-right">
                            <div class="form-group">
                                 <span class="btn btn-sm btn-primary pull-right" id="addSubscription">增加</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('payment_amount_pending',null,['class'=>'form-control', 'id' => 'payment_amount_pending', 'readonly']) !!}
                                ...
                                <div class="col-sm-6">
                                    ...
                                    {!! Form::select('mode',array('1' => '现金', '0' => '支票'),1,['class'=>'form-control selectpicker show-tick', 'id' => 'mode']) !!}
                                    </div>
                                </div>
                            </div> <!-- /Row -->
