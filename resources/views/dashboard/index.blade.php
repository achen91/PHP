        ...
        <div class="panel bg-light-blue-400">
            <div class="panel-body padding-15-20">
                <div class="clearfix">
                    ...
                    <div class="pull-left">
                        <div class="display-block color-light-blue-50 font-weight-600">全部会员</div>
                    </div>
                </div>
            </div>
        </div><!-- /.panel -->
        ...
        <div class="panel bg-teal-400">
            <div class="panel-body padding-15-20">
                <div class="clearfix">
                    ...
                    <div class="pull-left">
                        <div class="display-block color-teal-50 font-weight-600">没有新增会员</div>
                    </div>
                </div>
            </div>
        </div><!-- /.panel -->
        ...
        <div class="panel bg-amber-300">
            <div class="panel-body padding-15-20">
                <div class="clearfix">
                    ...
                    <div class="pull-left">
                        <div class="display-block color-amber-50 font-weight-600">未激活会员</div>
                    </div>
                </div>
            </div>
        </div><!-- /.panel -->
        ...
        <div class="panel bg-grey-500">
            <div class="panel-body padding-15-20">
                <div class="clearfix">
                    ...
                    <div class="pull-left">
                        <div class="display-block color-grey-50 font-weight-600">会费</div>
                    </div>
                </div>
            </div>
        </div><!-- /.panel -->
        ...
        <div class="panel bg-red-400">
            <div class="panel-body padding-15-20">
                <div class="clearfix">
                    ...
                    <div class="pull-left">
                        <div class="display-block color-red-50 font-weight-600">待付费</div>
                    </div>
                </div>
            </div>
        </div><!-- /.panel -->
        ...
        <div class="panel bg-green-400">
            <div class="panel-body padding-15-20">
                <div class="clearfix">
                    ...
                    <div class="pull-right">
                        <i class="font-size-24 color-green-100 fa fa-rmb"></i>
                    </div>

                    <div class="clearfix"></div>

                    <div class="pull-left">
                        <div class="display-block color-green-50 font-weight-600">月汇总</div>
                    </div>
                </div>
            </div>
        </div><!-- /.panel -->
    ...
    <div class="col-lg-6">
        <div class="panel">
            <div class="panel-title">
                <div class="panel-head"><i class="fa fa-users"></i><a href="{{ action('MembersController@index') }}">会员</a></div>
                <div class="pull-right"><a href="{{ action('MembersController@create') }}" class="btn-sm btn-primary active" role="button"><i class="fa fa-user-plus"></i> 添加</a></div>
            </div>

            <div class="panel-body with-nav-tabs">
                <!-- Tabs Heads -->
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#expiring" data-toggle="tab">将要到期<span class="label label-warning margin-left-5">{{ $expiringCount }}</span></a></li>
                    <li><a href="#expired" data-toggle="tab">到期<span class="label label-danger margin-left-5">{{ $expiredCount }}</span></a></li>
                    <li><a href="#birthdays" data-toggle="tab">生日<span class="label label-success margin-left-5">{{ $birthdayCount }}</span></a></li>
                    <li><a href="#recent" data-toggle="tab">新近</a></li>
                </ul>
...
<!--Enquiry Quick view Tabs-->
    <div class="col-lg-6">
        <div class="panel">
            <div class="panel-title">
                <div class="panel-head"><i class="fa fa-phone"></i><a href="{{ action('EnquiriesController@index') }}">咨询</a></div>
                <div class="pull-right"><a href="{{ action('EnquiriesController@create') }}" class="btn-sm btn-primary active" role="button"><i class="fa fa-phone"></i> 添加</a></div>
            </div>

            <div class="panel-body with-nav-tabs">
                <!-- Tabs Heads -->
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#enquiries" data-toggle="tab">咨询</a></li>
                    <li><a href="#reminders" data-toggle="tab">提醒<span class="label label-warning margin-left-5">{{ $reminderCount }}</span></a></li>
                </ul>
...
<!--Expense Quick view Tabs-->
    <div class="col-lg-6">
        <div class="panel">
            <div class="panel-title">
                <div class="panel-head"><i class="fa fa-rmb"></i><a href="{{ action('ExpensesController@index') }}">费用</a></div>
                <div class="pull-right"><a href="{{ action('ExpensesController@create') }}" class="btn-sm btn-primary active" role="button"><i class="fa fa-rmb"></i> 添加</a></div>
            </div>

            <div class="panel-body with-nav-tabs">
                <!-- Tabs Heads -->
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#due" data-toggle="tab">应缴款</a></li>
                    <li><a href="#outstanding" data-toggle="tab">未完成</a></li>
                </ul>
                        ...
                        <div class="table-responsive <?php echo (!$dues->isEmpty() ? "panel-scroll" : "") ?>">
                            <table class="table table-hover table-condensed">
                                ...
                                <tr>
                                    ...
                                    <td><a class="btn btn-info btn-xs btn pull-right" href="{{ action('ExpensesController@paid',['id' => $due->id]) }}">支付</a></td>
                                </tr>
                                @empty
                                       <div class="tab-empty-panel font-size-24 color-grey-300">
                                            No Data
...
@endpermission
    ...
    <div class="col-lg-6">
        <div class="panel">
            <div class="panel-title">
                <div class="panel-head"><i class="fa fa-credit-card-alt" aria-hidden="true"></i>信用卡</div>
            </div>

            <div class="panel-body with-nav-tabs">
                <!-- Tabs Heads -->
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#recieved" data-toggle="tab">到账<span class="label label-warning margin-left-5">{{ $recievedChequesCount }}</span></a></li>
                    <li><a href="#deposited" data-toggle="tab">预支付<span class="label label-primary margin-left-5">{{ $depositedChequesCount }}</span></a></li>
                    <li><a href="#bounced" data-toggle="tab">拒付<span class="label label-danger margin-left-5">{{ $bouncedChequesCount }}</span></a></li>
                </ul>
...
<div class="row">
    <div class="col-lg-6">
            <div class="panel">
                <div class="panel-title">
                    <div class="panel-head"><i class="fa fa-comments-o"></i>短信日志</div>
                </div>
    ...
    <div class="col-lg-12">
        <div class="panel bg-white">
            <div class="panel-title bg-transparent no-border">
                <div class="panel-head">注册会员走势图</div>
            </div>
