...
<div class="rightside bg-grey-100">
    ...
    <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
        ...
        <h1 class="page-title no-line-height">未激活会员
        <small>所有未激活会员的详细信息</small></h1>
        @permission(['manage-gymie','pagehead-stats'])
        <h1 class="font-size-30 text-right color-blue-grey-600 animated fadeInDown total-count pull-right"><span  data-toggle="counter" data-start="0" data-from="0" data-to="{{ $count }}" data-speed="600" data-refresh-interval="10"></span> <small class="color-blue-grey-600 display-block margin-top-5 font-size-14">未激活会员总数</small></h1>
        @endpermission
    </div><!-- / PageHead -->
                                ...
                                <div class="col-sm-12 no-padding">
                                    {!! Form::Open(['method' => 'GET']) !!}
                                        ...
                                        <div class="col-sm-2">                                        
                                            ...
                                            {!! Form::select('sort_field',array('created_at' => '日期','name' => '姓名', 'member_code' => '会员编码', 'plan_name' => '计划名称', 'status' => '状态'),old('sort_field'),['class' => 'form-control selectpicker show-tick show-menu-arrow', 'id' => 'sort_field']) !!}
                                        </div>
                                        ...
                                        <div class="col-xs-2">  
                                            {!! Form::label('&nbsp;') !!}  <br/>                                                                            
                                            <button type="submit" class="btn btn-primary active no-border">查找</button>
                                        </div>
