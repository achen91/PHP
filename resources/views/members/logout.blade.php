...
<div class="rightside bg-grey-100">
    ...
    <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
        ...
        <ul class="nav nav-tabs">
            ...
            <li id = "logoutHandle" class="active"><a href="{{ action('MembersController@logout') }}"><h3>会员注销</h3></a></li>
        </ul>
    </div><!-- / PageHead -->

    <div class = "scanlogoutInput">
        <h4>请刷手环注销:</h4>
        {!! Form::Open(['method' => 'GET']) !!}
        <input type = "pin_code_info" id = "ScanlogoutInfo" name = "pin_code_info" style = "margin-top: 10px;float:left"/>
        <input type = "submit" name = "sub" id = "startLogoutScanInfoButton" style = "float:left;margin-left:30px;margin-top: 10px;width:45px;" value = "确定"/>
        <input type = "button" id = "cleanScanlogoutInfoButton" style = "float:left;margin-left:10px;margin-top: 10px;width:45px;" value = "清除"/>
        {!! Form::Close() !!}
        ...
        <?php
            ...
            $name = Input::get("pin_code_info");

            if(($name == ($member->pin_code)) && ($name != 0))
            {
    ...
    <div class = "memberLogoutInfoDetail" id = "userLogoutInfoContainer">
    ...
    <div class = "cardFlashLogoutInput" id = "cardFlashLogoutInput">
        <h4>确定要注销吗？</h4>
        ...
        <input type = "text" name = "pin_code" id = "internalCardInfo" name = "text" value = "0" style = "margin-top: 10px;float:left;display:none"/>
...
@section('footer_script_init')
    <script type="text/javascript" runat = "server">
        ...
        function cyclicTask() {
            ...
            if(loginMemberReq == 1) {
                document.getElementById("userLogoutInfoContainer").style.display = "block";
                if(loginMemberPinCode != 0) {
                    document.getElementById("userInfoLoginSts").innerHTML = "已签到";
                    document.getElementById("userInfoLoginId").innerHTML = loginMemberPinCode;
                    document.getElementById("cardFlashLogoutInput").style.display = "block";
                }else {
                    document.getElementById("userInfoLoginSts").innerHTML = "未签到";
                    document.getElementById("userInfoLoginId").innerHTML = "-";
                    document.getElementById("cardFlashLogoutInput").style.display = "none";
                }
            }else {
                document.getElementById("userLogoutInfoContainer").style.display = "none";
                document.getElementById("cardFlashLogoutInput").style.display = "none";
            }
        }
        ...
        function eventListenreStart() {
            ...
            document.getElementById("cleanScanlogoutInfoButton").addEventListener("click", function() {
                document.getElementById("ScanlogoutInfo").value = "";
            });    
            ...
            document.getElementById("startLogoutScanInfoButton").addEventListener("click", function() {
