...
@section('content')
      <div class="rightside bg-grey-100">
            ...
            <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
                  ...
                  <h1 class="page-title">SMS记录<small>完整的sms记录信息</small></h1>
            </div>
                              ...
                              <div class="panel no-border ">
                                    <div class="panel-body no-padding-top bg-white">                                       
                                          <div class="row margin-top-15 margin-bottom-15"> 
                                            <div class="col-xs-6">
                                              <a href="{{ action('SmsController@logRefresh') }}" class="btn btn-labeled btn-info"><span class="btn-label"><i class="glyphicon glyphicon-refresh"></i></span>刷新</a>
                                            </div>                                                                              
                                          ...
                                          <div class="row">
                                                <div class="col-xs-6">
                                                      <div class="gymie_paging_info">
                                                          当前页: {{ $smslogs->currentPage() }} / {{ $smslogs->lastPage() }}
                                                      </div>
                                                </div>
