...
<div class="rightside bg-grey-100">
  <!-- BEGIN PAGE HEADING -->
    <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
        ...
        <small>多付单据详细信息</small></h1>
        @permission(['manage-gymie','pagehead-stats'])
        <h1 class="font-size-30 text-right color-blue-grey-600 animated fadeInDown total-count pull-right"><span  data-toggle="counter" data-start="0" data-from="0" data-to="{{ $count }}" data-speed="600" data-refresh-interval="10"></span> <small class="color-blue-grey-600 display-block margin-top-5 font-size-14">多付单据总数</small></h1>
        @endpermission
    </div><!-- / PageHead -->
                                ...
                                <div class="col-sm-12 no-padding">
                                    {!! Form::Open(['method' => 'GET']) !!}
                                        ...
                                        <div class="col-sm-2">                                        
                                            ...
                                            {!! Form::select('sort_field',array('created_at' => '日期','invoice_number' => '单据号','member_name' => '成员名','total' => '总费用','pending_amount' => '冻结费用'),old('sort_field'),['class' => 'form-control selectpicker show-tick show-menu-arrow', 'id' => 'sort_field']) !!}
                                        </div>
