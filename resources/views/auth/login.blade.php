	...
	<body class="auth-page height-auto bg-grey-600">
		...
		<div class="panel overflow-hidden">
			<div class="bg-grey-900 padding-40 no-margin-bottom font-size-20 color-white text-center text-uppercase">
				<img src="{{ asset('assets/img/web/logo_black.png') }}">
			</div>
			@if (count($errors) > 0)
						<div class="alert alert-danger">
							<strong>啊哦!</strong> 您输入有误!<br><br>
							<ul>
			...
			<form id="loginform" method="post" action="{{ url('/auth/login') }}" >
				...
				<div class="box-body padding-md">
					...
					<button type="submit" class="btn btn-dark bg-light-green-500 padding-10 btn-block color-white"><i class="ion-log-in"></i> 登录</button>  
				</div>
			</form>
			<div class="panel-footer padding-md no-margin no-border bg-grey-900 text-center color-white">&copy; 2018 Gym management by Wuyou Wellness</div>
		</div>
	</div>
