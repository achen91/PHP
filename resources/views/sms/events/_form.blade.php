                ...
                ?>
							<div class="panel-body">								 								
							    ...
							    <div class="row">
									<div class="col-sm-6">
							    		<div class="form-group">
											{!! Form::label('send_to','发送到') !!}
											{!! Form::select('send_to[]',array('0' => '激活会员', '1' => '未激活会员', '2' => '主要查询者', '3' => '丢失查询者'),null,['class'=>'form-control selectpicker show-tick show-menu-arrow','multiple' => 'multiple', 'id' => 'send_to']) !!}		
										</div>							
								    </div>								
							    </div>	
