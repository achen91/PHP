...
@section('content')
    ...
    <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
        ...
        <h1 class="page-title no-line-height">服务
        @permission(['manage-gymie','manage-services','add-service'])
        <a href="{{ action('ServicesController@create') }}" class="page-head-btn btn-sm btn-primary active" role="button">新增</a>
        <small>gym服务的详细信息</small></h1>
        @permission(['manage-gymie','pagehead-stats'])
        <h1 class="font-size-30 text-right color-blue-grey-600 animated fadeInDown total-count pull-right"><span  data-toggle="counter" data-start="0" data-from="0" data-to="{{ $count }}" data-speed="600" data-refresh-interval="10"></span> <small class="color-blue-grey-600 display-block margin-top-5 font-size-14">服务总数</small></h1>
        @endpermission
        @endpermission
    </div><!-- / PageHead -->
                                          ...
                                          <div class="row">
                                                <div class="col-xs-6">
                                                      <div class="gymie_paging_info">
                                                          当前页: {{ $services->currentPage() }} / {{ $services->lastPage() }}
                                                      </div>
                                                </div>
