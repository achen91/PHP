...
Route::post('wechatmp','WeixinController@responseMsg');
...
Route::group(['prefix' => 'members', 'middleware' => ['auth']], function () {
    ...
    Route::get('launch', ['middleware' => ['permission:manage-gymie|manage-members|view-member'], 'uses' => 'MembersController@launch']);
    Route::get('logout', ['middleware' => ['permission:manage-gymie|manage-members|view-member'], 'uses' => 'MembersController@logout']);
    Route::get('showMemSts', ['middleware' => ['permission:manage-gymie|manage-members|view-member'], 'uses' => 'MembersController@showMemSts']);
    ...
    Route::post('{id}/updatePinCode', ['middleware' => ['permission:manage-gymie|manage-members|edit-member'], 'uses' => 'MembersController@updatePinCode']);
...
Route::group(['prefix' => 'settings', 'middleware' => ['permission:manage-gymie|manage-settings', 'auth']], function () {
	...
	//settings
	Route::group(['prefix' => 'test', 'middleware' => ['permission:manage-gymie|manage-settings', 'auth']], function () {
